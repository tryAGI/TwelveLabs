...
{
    public partial class MultipartUploadClient
    {


        private static readonly global::TwelveLabs.EndPointSecurityRequirement s_GetAdditionalPresignedUrlsSecurityRequirement0 =
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement[] s_GetAdditionalPresignedUrlsSecurityRequirements =
            new global::TwelveLabs.EndPointSecurityRequirement[]
            {                s_GetAdditionalPresignedUrlsSecurityRequirement0,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::TwelveLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAdditionalPresignedUrlsSecurityRequirements,
                operationName: "GetAdditionalPresignedUrlsAsync");
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.RequestAdditionalPresignedUrlsRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.RequestAdditionalPresignedUrlsRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.RequestAdditionalPresignedUrlsRequestBadRequestError>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::TwelveLabs.RequestAdditionalPresignedUrlsRequestForbiddenError? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::TwelveLabs.RequestAdditionalPresignedUrlsRequestForbiddenError.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.RequestAdditionalPresignedUrlsRequestForbiddenError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::TwelveLabs.RequestAdditionalPresignedUrlsRequestInternalServerError? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::TwelveLabs.RequestAdditionalPresignedUrlsRequestInternalServerError.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.RequestAdditionalPresignedUrlsRequestInternalServerError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::TwelveLabs.RequestAdditionalPresignedURLsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::TwelveLabs.AutoSDKHttpResponse<global::TwelveLabs.RequestAdditionalPresignedURLsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::TwelveLabs.RequestAdditionalPresignedURLsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.RequestAdditionalPresignedURLsResponse> GetAdditionalPresignedUrlsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::TwelveLabs.RequestAdditionalPresignedURLsRequest
            {
                Start = start,
                Count = count,
            };
