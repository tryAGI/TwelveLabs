...
namespace TwelveLabs
{
    public partial class KnowledgeStoreItemCollectionsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.KnowledgeStoreItemCollection> UpdateAsync(
            string knowledgeStoreId,
            string collectionId,
            string xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::TwelveLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.AutoSDKHttpResponse<global::TwelveLabs.KnowledgeStoreItemCollection>> UpdateAsResponseAsync(
            string knowledgeStoreId,
            string collectionId,
            string xApiKey,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.UpdateKnowledgeStoreItemCollectionRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.UpdateKnowledgeStoreItemCollectionRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.UpdateKnowledgeStoreItemCollectionRequestBadRequestError>.Create(
