...
namespace TwelveLabs
{
    ...
    {
        /// <summary>
        /// The start of the window, as an absolute timestamp in seconds, based on the internal metadata of the video. Must be less than `end_time` and within the video duration.<br/>
        ...
        /// <summary>
        /// The end of the window, as an absolute timestamp in seconds, based on the internal metadata of the video. Must be greater than `start_time` by at least `2` seconds and within the video duration.<br/>
        /// Most videos start at 0, but some (for example, from cameras or broadcast recordings) may have a non-zero start time. To find the value, run `ffprobe -v error -show_entries format=start_time,duration -of default=noprint_wrappers=1 your_video.mp4`.
        /// </summary>
