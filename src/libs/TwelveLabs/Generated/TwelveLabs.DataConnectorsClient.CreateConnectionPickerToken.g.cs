...
namespace TwelveLabs
{
    public partial class DataConnectorsClient
    {
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement s_CreateConnectionPickerTokenSecurityRequirement0 =
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement[] s_CreateConnectionPickerTokenSecurityRequirements =
            new global::TwelveLabs.EndPointSecurityRequirement[]
            {                s_CreateConnectionPickerTokenSecurityRequirement0,
            };
        ...
        partial void ProcessCreateConnectionPickerTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::TwelveLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateConnectionPickerTokenSecurityRequirements,
                operationName: "CreateConnectionPickerTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::TwelveLabs.PathBuilder(
                                path: $"/connections/{connectionId}/picker-token",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::TwelveLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateConnectionPickerToken",
                                methodName: "CreateConnectionPickerTokenAsync",
                                pathTemplate: "$\"/connections/{connectionId}/picker-token\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateConnectionPickerTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.CreateConnectionPickerTokenRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.CreateConnectionPickerTokenRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.CreateConnectionPickerTokenRequestBadRequestError>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::TwelveLabs.CreateConnectionPickerTokenRequestNotFoundError? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::TwelveLabs.CreateConnectionPickerTokenRequestNotFoundError.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.CreateConnectionPickerTokenRequestNotFoundError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                global::TwelveLabs.CreateConnectionPickerTokenRequestConflictError? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::TwelveLabs.CreateConnectionPickerTokenRequestConflictError.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.CreateConnectionPickerTokenRequestConflictError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateConnectionPickerTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::TwelveLabs.DataConnectorsCreateConnectionPickerTokenResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::TwelveLabs.AutoSDKHttpResponse<global::TwelveLabs.DataConnectorsCreateConnectionPickerTokenResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::TwelveLabs.DataConnectorsCreateConnectionPickerTokenResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
