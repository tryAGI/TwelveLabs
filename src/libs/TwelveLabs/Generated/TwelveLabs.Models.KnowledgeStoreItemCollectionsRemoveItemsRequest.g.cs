...
namespace TwelveLabs
{
    ...
    public sealed partial class KnowledgeStoreItemCollectionsRemoveItemsRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeStoreItemCollectionsRemoveItemsRequest" /> class.
        /// </summary>
        /// <param name="itemIds">
        /// The unique identifiers of the items to remove from the collection. Include up to 500 identifiers per request.
        /// </param>
...
#endif
        public KnowledgeStoreItemCollectionsRemoveItemsRequest(
