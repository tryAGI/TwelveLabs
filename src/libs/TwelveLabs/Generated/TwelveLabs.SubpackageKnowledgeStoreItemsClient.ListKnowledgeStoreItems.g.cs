...
namespace TwelveLabs
{
    public partial class SubpackageKnowledgeStoreItemsClient
    {
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement s_ListKnowledgeStoreItemsSecurityRequirement0 =
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement[] s_ListKnowledgeStoreItemsSecurityRequirements =
            new global::TwelveLabs.EndPointSecurityRequirement[]
            {                s_ListKnowledgeStoreItemsSecurityRequirement0,
            };
        partial void PrepareListKnowledgeStoreItemsArguments(
            ...
            ref string xApiKey);
        partial void PrepareListKnowledgeStoreItemsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<global::TwelveLabs.KnowledgeStoresKnowledgeStoreIdItemsGetParametersStatusSchemaItems>? status,
            string xApiKey);
        partial void ProcessListKnowledgeStoreItemsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListKnowledgeStoreItemsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.KnowledgeStoreItemsListKnowledgeStoreItemsResponse200> ListKnowledgeStoreItemsAsync(
            string knowledgeStoreId,
            string xApiKey,
            int? page = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListKnowledgeStoreItemsArguments(
            ...
            var __authorizations = global::TwelveLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListKnowledgeStoreItemsSecurityRequirements,
                operationName: "ListKnowledgeStoreItemsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListKnowledgeStoreItemsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::TwelveLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListKnowledgeStoreItems",
                                methodName: "ListKnowledgeStoreItemsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListKnowledgeStoreItemsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.ListKnowledgeStoreItemsRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.ListKnowledgeStoreItemsRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::TwelveLabs.ApiException<global::TwelveLabs.ListKnowledgeStoreItemsRequestBadRequestError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListKnowledgeStoreItemsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::TwelveLabs.KnowledgeStoreItemsListKnowledgeStoreItemsResponse200.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::TwelveLabs.KnowledgeStoreItemsListKnowledgeStoreItemsResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
