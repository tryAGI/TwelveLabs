...
namespace TwelveLabs
{
    public partial class KnowledgeStoreItemCollectionsClient
    {
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement s_AddItemsSecurityRequirement0 =
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement[] s_AddItemsSecurityRequirements =
            new global::TwelveLabs.EndPointSecurityRequirement[]
            {                s_AddItemsSecurityRequirement0,
            };
        partial void PrepareAddItemsArguments(
        ...
        partial void ProcessAddItemsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::TwelveLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddItemsSecurityRequirements,
                operationName: "AddItemsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::TwelveLabs.PathBuilder(
                                path: $"/knowledge-stores/{knowledgeStoreId}/item-collections/{collectionId}/items/add",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::TwelveLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AddItemsAsync",
                                pathTemplate: "$\"/knowledge-stores/{knowledgeStoreId}/item-collections/{collectionId}/items/add\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.AddItemsToKnowledgeStoreItemCollectionRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.AddItemsToKnowledgeStoreItemCollectionRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.AddItemsToKnowledgeStoreItemCollectionRequestBadRequestError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddItemsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::TwelveLabs.KnowledgeStoreItemCollection.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::TwelveLabs.AutoSDKHttpResponse<global::TwelveLabs.KnowledgeStoreItemCollection>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::TwelveLabs.KnowledgeStoreItemCollection.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
