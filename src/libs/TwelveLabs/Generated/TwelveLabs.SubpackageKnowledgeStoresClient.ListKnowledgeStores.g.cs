...
namespace TwelveLabs
{
    public partial class SubpackageKnowledgeStoresClient
    {
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement s_ListKnowledgeStoresSecurityRequirement0 =
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement[] s_ListKnowledgeStoresSecurityRequirements =
            new global::TwelveLabs.EndPointSecurityRequirement[]
            {                s_ListKnowledgeStoresSecurityRequirement0,
            };
        partial void PrepareListKnowledgeStoresArguments(
            ...
            ref string xApiKey);
        partial void PrepareListKnowledgeStoresRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? sortOption,
            string xApiKey);
        partial void ProcessListKnowledgeStoresResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListKnowledgeStoresResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.KnowledgeStoresListKnowledgeStoresResponse200> ListKnowledgeStoresAsync(
            string xApiKey,
            int? page = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListKnowledgeStoresArguments(
            ...
            var __authorizations = global::TwelveLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListKnowledgeStoresSecurityRequirements,
                operationName: "ListKnowledgeStoresAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListKnowledgeStoresRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::TwelveLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListKnowledgeStores",
                                methodName: "ListKnowledgeStoresAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListKnowledgeStoresResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.ListKnowledgeStoresRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.ListKnowledgeStoresRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::TwelveLabs.ApiException<global::TwelveLabs.ListKnowledgeStoresRequestBadRequestError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListKnowledgeStoresResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::TwelveLabs.KnowledgeStoresListKnowledgeStoresResponse200.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::TwelveLabs.KnowledgeStoresListKnowledgeStoresResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
