...
namespace TwelveLabs
{
    public partial class SubpackageKnowledgeStoresClient
    {
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement s_RetrieveKnowledgeStoreSecurityRequirement0 =
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement[] s_RetrieveKnowledgeStoreSecurityRequirements =
            new global::TwelveLabs.EndPointSecurityRequirement[]
            {                s_RetrieveKnowledgeStoreSecurityRequirement0,
            };
        partial void PrepareRetrieveKnowledgeStoreArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string knowledgeStoreId,
            ref string xApiKey);
        partial void PrepareRetrieveKnowledgeStoreRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string knowledgeStoreId,
            string xApiKey);
        partial void ProcessRetrieveKnowledgeStoreResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRetrieveKnowledgeStoreResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.KnowledgeStore> RetrieveKnowledgeStoreAsync(
            string knowledgeStoreId,
            string xApiKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRetrieveKnowledgeStoreArguments(
            ...
            var __authorizations = global::TwelveLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RetrieveKnowledgeStoreSecurityRequirements,
                operationName: "RetrieveKnowledgeStoreAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRetrieveKnowledgeStoreRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::TwelveLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RetrieveKnowledgeStore",
                                methodName: "RetrieveKnowledgeStoreAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRetrieveKnowledgeStoreResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.RetrieveKnowledgeStoreRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.RetrieveKnowledgeStoreRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::TwelveLabs.ApiException<global::TwelveLabs.RetrieveKnowledgeStoreRequestBadRequestError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRetrieveKnowledgeStoreResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
