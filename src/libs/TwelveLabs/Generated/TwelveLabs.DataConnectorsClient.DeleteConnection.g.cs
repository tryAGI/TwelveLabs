...
namespace TwelveLabs
{
    public partial class DataConnectorsClient
    {
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement s_DeleteConnectionSecurityRequirement0 =
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement[] s_DeleteConnectionSecurityRequirements =
            new global::TwelveLabs.EndPointSecurityRequirement[]
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.DeleteConnectionRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.DeleteConnectionRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.DeleteConnectionRequestBadRequestError>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::TwelveLabs.DeleteConnectionRequestNotFoundError? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::TwelveLabs.DeleteConnectionRequestNotFoundError.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.DeleteConnectionRequestNotFoundError>.Create(
                                    statusCode: __response.StatusCode,
