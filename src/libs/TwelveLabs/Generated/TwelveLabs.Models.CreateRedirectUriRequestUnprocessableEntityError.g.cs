...
namespace TwelveLabs
{
    ...
    public sealed partial class CreateRedirectUriRequestUnprocessableEntityError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRedirectUriRequestUnprocessableEntityError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public CreateRedirectUriRequestUnprocessableEntityError(
            string? code,
            string? message,
            string? docsUrl)
        {
