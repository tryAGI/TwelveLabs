...
namespace TwelveLabs
{
    ...
    /// 
    /// </summary>
    public sealed partial class ImportFilesRequestConflictError
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportFilesRequestConflictError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public ImportFilesRequestConflictError(
            string? code,
            string? message,
            string? docsUrl)
        {
