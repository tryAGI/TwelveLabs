...
namespace TwelveLabs
{
    public partial class EntityCollectionsEntitiesClient
    {
        ...
        partial void PrepareCreateArguments(
            ...
            ref string xApiKey,
            global::TwelveLabs.EntityCollectionsEntitiesCreateRequest request);
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.CreateEntityRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.CreateEntityRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.CreateEntityRequestBadRequestError>.Create(
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.Entity> CreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::TwelveLabs.EntityCollectionsEntitiesCreateRequest
            {
                Name = name,
