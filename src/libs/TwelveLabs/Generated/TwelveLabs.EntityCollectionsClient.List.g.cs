...
{
    public partial class EntityCollectionsClient
    {
        ...
        partial void PrepareListArguments(
            ...
            ref int? pageLimit,
            ref string? name,
            ref global::TwelveLabs.EntityCollectionsGetParametersSortBy? sortBy,
        ...
        partial void PrepareListRequest(
            ...
            int? pageLimit,
            string? name,
            global::TwelveLabs.EntityCollectionsGetParametersSortBy? sortBy,
            string? sortOption,
            string xApiKey);
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.EntityCollectionsListResponse200> ListAsync(
            string xApiKey,
            int? page = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::TwelveLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.AutoSDKHttpResponse<global::TwelveLabs.EntityCollectionsListResponse200>> ListAsResponseAsync(
            string xApiKey,
            int? page = default,
            int? pageLimit = default,
            string? name = default,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.ListEntityCollectionsRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.ListEntityCollectionsRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.ListEntityCollectionsRequestBadRequestError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::TwelveLabs.EntityCollectionsListResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::TwelveLabs.AutoSDKHttpResponse<global::TwelveLabs.EntityCollectionsListResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::TwelveLabs.EntityCollectionsListResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
