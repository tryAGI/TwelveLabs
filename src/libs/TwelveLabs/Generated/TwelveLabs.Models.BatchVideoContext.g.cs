...
namespace TwelveLabs
{
    ...
    public sealed partial class BatchVideoContext
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::TwelveLabs.JsonConverters.BatchVideoContextTypeJsonConverter))]
        public global::TwelveLabs.BatchVideoContextType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchVideoContext" /> class.
        /// </summary>
        /// <param name="assetId">
        /// The unique identifier of an asset from a [direct](/v1.3/api-reference/upload-content/direct-uploads) or [multipart](/v1.3/api-reference/upload-content/multipart-uploads) upload. The asset status must be `ready`. Use the [Retrieve an asset](/v1.3/api-reference/upload-content/direct-uploads/retrieve) method to check the status.
        /// </param>
...
#endif
        public BatchVideoContext(
            string assetId,
            global::TwelveLabs.BatchVideoContextType type)
        {
            this.Type = type;
