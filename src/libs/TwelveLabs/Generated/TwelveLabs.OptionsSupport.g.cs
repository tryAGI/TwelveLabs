...
namespace TwelveLabs
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::TwelveLabs.AutoSDKRetryOptions Retry { get; set; } = new global::TwelveLabs.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::TwelveLabs.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::TwelveLabs.IAutoSDKHook>();
        ...
        public global::TwelveLabs.AutoSDKClientOptions AddHook(
            global::TwelveLabs.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::TwelveLabs.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::TwelveLabs.AutoSDKClientOptions UseAuthorizationProvider(
            global::TwelveLabs.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::TwelveLabs.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::TwelveLabs.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::TwelveLabs.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::TwelveLabs.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::TwelveLabs.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::TwelveLabs.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::TwelveLabs.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::TwelveLabs.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::TwelveLabs.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::TwelveLabs.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::TwelveLabs.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::TwelveLabs.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::TwelveLabs.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::TwelveLabs.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::TwelveLabs.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::TwelveLabs.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::TwelveLabs.AutoSDKClientOptions clientOptions,
            global::TwelveLabs.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::TwelveLabs.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::TwelveLabs.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::TwelveLabs.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::TwelveLabs.AutoSDKClientOptions clientOptions,
            global::System.Func<global::TwelveLabs.IAutoSDKHook, global::TwelveLabs.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::TwelveLabs.AutoSDKHookContext context)
        {
