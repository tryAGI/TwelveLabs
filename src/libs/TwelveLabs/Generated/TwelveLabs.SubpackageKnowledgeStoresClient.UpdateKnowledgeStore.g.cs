...
namespace TwelveLabs
{
    public partial class SubpackageKnowledgeStoresClient
    {
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement s_UpdateKnowledgeStoreSecurityRequirement0 =
        ...
        private static readonly global::TwelveLabs.EndPointSecurityRequirement[] s_UpdateKnowledgeStoreSecurityRequirements =
            new global::TwelveLabs.EndPointSecurityRequirement[]
            {                s_UpdateKnowledgeStoreSecurityRequirement0,
            };
        partial void PrepareUpdateKnowledgeStoreArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string knowledgeStoreId,
            ref string xApiKey,
            global::TwelveLabs.UpdateKnowledgeStoreRequest request);
        partial void PrepareUpdateKnowledgeStoreRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string knowledgeStoreId,
            string xApiKey,
            global::TwelveLabs.UpdateKnowledgeStoreRequest request);
        partial void ProcessUpdateKnowledgeStoreResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateKnowledgeStoreResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.KnowledgeStore> UpdateKnowledgeStoreAsync(
            string knowledgeStoreId,
            string xApiKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateKnowledgeStoreArguments(
            ...
            var __authorizations = global::TwelveLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateKnowledgeStoreSecurityRequirements,
                operationName: "UpdateKnowledgeStoreAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateKnowledgeStoreRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::TwelveLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateKnowledgeStore",
                                methodName: "UpdateKnowledgeStoreAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateKnowledgeStoreResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw new global::TwelveLabs.ApiException<global::TwelveLabs.UpdateKnowledgeStoreRequestBadRequestError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateKnowledgeStoreResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.KnowledgeStore> UpdateKnowledgeStoreAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::TwelveLabs.UpdateKnowledgeStoreRequest
            {
                Name = name,
            ...
            return await UpdateKnowledgeStoreAsync(
                knowledgeStoreId: knowledgeStoreId,
                xApiKey: xApiKey,
                request: __request,
                requestOptions: requestOptions,
