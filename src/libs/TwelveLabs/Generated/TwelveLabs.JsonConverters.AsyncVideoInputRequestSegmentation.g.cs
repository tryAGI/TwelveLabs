...
{
    /// <inheritdoc />
    public class AsyncVideoInputRequestSegmentationJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::TwelveLabs.AsyncVideoInputRequestSegmentation>
    {
        /// <inheritdoc />
        public override global::TwelveLabs.AsyncVideoInputRequestSegmentation Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::TwelveLabs.VideoSegmentation? videoSegmentation = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        videoSegmentation = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (videoSegmentation == null && asyncTemporalSegmentation == null)
            {
                try
                {
            ...
            var __value = new global::TwelveLabs.AsyncVideoInputRequestSegmentation(
                videoSegmentation,
        ...
        public override void Write(
            ...
            global::TwelveLabs.AsyncVideoInputRequestSegmentation value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsVideoSegmentation)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::TwelveLabs.VideoSegmentation), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::TwelveLabs.VideoSegmentation> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::TwelveLabs.VideoSegmentation).Name}");
