...
{
    /// <inheritdoc />
    public class UserMetadataValueJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::TwelveLabs.UserMetadataValue>
    {
        /// <inheritdoc />
        public override global::TwelveLabs.UserMetadataValue Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            string? userMetadataValueVariant1 = default;
            int? userMetadataValueVariant2 = default;
            double? userMetadataValueVariant3 = default;
            bool? userMetadataValueVariant4 = default;
            global::System.Collections.Generic.IList<string>? userMetadataValueVariant5 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        userMetadataValueVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        userMetadataValueVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        userMetadataValueVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 3)
                {
                    try
                    {
                        ...
                        userMetadataValueVariant4 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 4)
                {
                    try
                    {
                        ...
                        userMetadataValueVariant5 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (userMetadataValueVariant1 == null && userMetadataValueVariant2 == null && userMetadataValueVariant3 == null && userMetadataValueVariant4 == null && userMetadataValueVariant5 == null)
            {
                try
                {
            ...
            var __value = new global::TwelveLabs.UserMetadataValue(
        ...
        public override void Write(
            ...
            global::TwelveLabs.UserMetadataValue value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsUserMetadataValueVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
