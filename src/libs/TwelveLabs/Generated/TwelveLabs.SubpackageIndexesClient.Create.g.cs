                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw new global::TwelveLabs.ApiException<global::TwelveLabs.CreateIndexRequestBadRequestError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::TwelveLabs.IndexesCreateResponse201.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::TwelveLabs.IndexesCreateResponse201.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
