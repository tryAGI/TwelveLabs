...
namespace TwelveLabs
{
    ...
    public sealed partial class RetrieveKnowledgeStoreItemCollectionRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveKnowledgeStoreItemCollectionRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public RetrieveKnowledgeStoreItemCollectionRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
