...
namespace TwelveLabs
{
    ...
    public sealed partial class VideoContextVariant2
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::TwelveLabs.JsonConverters.VideoContextVariant2TypeJsonConverter))]
        public global::TwelveLabs.VideoContextVariant2Type Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoContextVariant2" /> class.
        /// </summary>
        /// <param name="assetId">
        /// The unique identifier of an asset from a [direct](/v1.3/api-reference/upload-content/direct-uploads) or [multipart](/v1.3/api-reference/upload-content/multipart-uploads) upload. The asset status must be `ready`. Use the [Retrieve an asset](/v1.3/api-reference/upload-content/direct-uploads/retrieve) method to check the status.
        /// </param>
...
#endif
        public VideoContextVariant2(
            string assetId,
            global::TwelveLabs.VideoContextVariant2Type type)
        {
            this.Type = type;
