...
namespace TwelveLabs
{
    public partial class KnowledgeStoreItemCollectionsClient
    {
        ...
        partial void PrepareListArguments(
            ...
            ref int? page,
            ref int? pageLimit,
            ref global::TwelveLabs.KnowledgeStoresKnowledgeStoreIdItemCollectionsGetParametersSortBy? sortBy,
        ...
        partial void PrepareListRequest(
            ...
            int? page,
            int? pageLimit,
            global::TwelveLabs.KnowledgeStoresKnowledgeStoreIdItemCollectionsGetParametersSortBy? sortBy,
            string? sortOption,
            string xApiKey);
        ...
        /// <summary>
        /// List knowledge store item collections<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.KnowledgeStoreItemCollectionsListResponse200> ListAsync(
            string knowledgeStoreId,
            string xApiKey,
            int? page = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::TwelveLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::TwelveLabs.AutoSDKHttpResponse<global::TwelveLabs.KnowledgeStoreItemCollectionsListResponse200>> ListAsResponseAsync(
            string knowledgeStoreId,
            string xApiKey,
            int? page = default,
            int? pageLimit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::TwelveLabs.PathBuilder(
                                path: $"/knowledge-stores/{knowledgeStoreId}/item-collections",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::TwelveLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/knowledge-stores/{knowledgeStoreId}/item-collections\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::TwelveLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::TwelveLabs.ListKnowledgeStoreItemCollectionsRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::TwelveLabs.ListKnowledgeStoreItemCollectionsRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::TwelveLabs.ApiException<global::TwelveLabs.ListKnowledgeStoreItemCollectionsRequestBadRequestError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::TwelveLabs.KnowledgeStoreItemCollectionsListResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::TwelveLabs.AutoSDKHttpResponse<global::TwelveLabs.KnowledgeStoreItemCollectionsListResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::TwelveLabs.KnowledgeStoreItemCollectionsListResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
