...
namespace TwelveLabs
{
    ...
    /// </summary>
    public static class AssetDetailStatusExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this AssetDetailStatus value)
        {
            return value switch
            {
                AssetDetailStatus.Failed => "failed",
                AssetDetailStatus.Processing => "processing",
                AssetDetailStatus.Ready => "ready",
        ...
        /// </summary>
        public static AssetDetailStatus? ToEnum(string value)
        {
            return value switch
            {
                "failed" => AssetDetailStatus.Failed,
                "processing" => AssetDetailStatus.Processing,
                "ready" => AssetDetailStatus.Ready,
                _ => null,
            };
        }
    }
