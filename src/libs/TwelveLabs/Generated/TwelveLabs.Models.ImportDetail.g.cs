...
namespace TwelveLabs
{
    ...
    public sealed partial class ImportDetail
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::TwelveLabs.JsonConverters.ImportDetailProviderJsonConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportDetail" /> class.
        /// </summary>
        /// <param name="id">
        /// The unique identifier of the import.
        /// </param>
        ...
        public ImportDetail(
            string? id,
            string? connectionId,
            global::TwelveLabs.ImportDetailProvider? provider,
            string? customId,
            int? itemCount,
